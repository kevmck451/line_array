...
if __name__ == '__main__':
    ...
    base_path = '/Users/KevMcK/Dropbox/1 EE Degree/7996 Thesis/3 Data/Line Array/Field Test'
    directory = 'Test 2 2-24'
    # filename = '1 First Look'
    # filename = 'E2_T1_Full_Raw'
    filename = 'E2_T2_Full_Raw'
    filepath = f'{base_path}/{directory}/exports/{filename}.wav'
    filepath_save = f'{base_path}/{directory}/exports'
    tag_index = '-Ensemble'
