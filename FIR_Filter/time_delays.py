...
def calculate_directional_cosines(theta):
...
def calculate_time_delays(mic_positions, theta, temperature_F, sample_rate):
    """
    ...
    wx, wy, wz = calculate_directional_cosines(theta)
    ...
    # reshape to grid
    time_delays = time_delays.reshape(1, mic_positions.shape[0])
