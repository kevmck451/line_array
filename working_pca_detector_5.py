...
if __name__ == '__main__':
    ...
    for filter in filters:
        ...
        for num_comps in num_comps_list:
            ...
            plot_titles = [f'Raw Ch1 - LP: {filter}_5x - PCA Comps: {num_comps}',
                           f'Beamed 12 Mics - LP: {filter}_5x - PCA Comps: {num_comps}',
                           f'Beam Mixture - LP: {filter}_5x - PCA Comps: {num_comps}']

            save_tags = [f'RawCh1_LP{filter}_5x_PCA{num_comps}',
                         f'BF12m_LP{filter}_5x_PCA{num_comps}',
                         f'BMix_LP{filter}_5x_PCA{num_comps}']
